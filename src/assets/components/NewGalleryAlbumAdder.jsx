...
const NewGalleryItemAdder = () => {
  ...
  function newGalleryData() {
    return (
      <div className="row mb-4 ">
        <div className="col-6">
          <Form>
            <Form.Group className="mb-4">
              <Form.Label className="input-labels">Add album Title</Form.Label>
              <Form.Control
                type="text"
        ...
        <div className="col-12 gallery-album-name">
          <Form>
            <Form.Group>
              <Form.Label className="input-labels">Add album Images</Form.Label>
              <Form.Control
                ref={AlbumImageInput}
                type="file"
    ...
    <>
      <section className="album-adder">
        ...
        <div className="container">
          ...
          <div className="data-adder">{newGalleryData()}</div>
        </div>
      </section>
      <CustomPopup
        show={showSavePopup}
